<?php /*a:1:{s:62:"D:\wamp64\www\amzcount\application\admin\view\index\index.html";i:1622367810;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="width: 98%;height:200px;margin: 0 auto;">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item" style="float:left">
            <input type="button" id="do_sync_btn" class="layui-btn layui-btn-primary layui-border-black" style="width:100px;height:30px;line-height:30px;margin-left:5px;text-align:center;background-color:#F5F5F5;border-color: #D3D3D3 !important;" value="手动同步">
        </div>
        ...
        <div class="layui-form-item">
            <input type="button" id="stop_sync_btn" class="layui-btn layui-btn-primary layui-border-black" style="width:100px;height:30px;line-height:30px;margin-left:5px;text-align:center;background-color:#F5F5F5;border-color: #D3D3D3 !important;" value="终止同步">
        </div>
    </form>
    ...
    <div class="search_form" style="margin-top: 10px;">
        <form class="layui-form" action="">
            <div class="layui-form-item">
                ...
                <input type="button" class="layui-btn search" style="height: 29px;line-height: 29px;margin-top: -5px" value="搜索">
...
<script>
    layui.use('table', function(){
        ...
        form.on('switch(task_state)',function (data) {
            ...
            if(checked){
                htmlobj=$.ajax({ url:"/admin/Index/openTask",async:false });
                if(htmlobj==1){
                    layer.msg('定时任务开启成功')
                }
            }else{
                htmlobj=$.ajax({ url:"/admin/Index/closeTask",async:false });
                if(htmlobj==1){
                    layer.msg('定时任务已关闭')
                }
            }
